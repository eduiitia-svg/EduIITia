        ...
        <div className="relative space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-xl bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-white/5">
              <p className="text-gray-600 dark:text-gray-500 mb-1">Category</p>
            ...
            <div className="p-4 rounded-xl bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-white/5">
              <p className="text-gray-600 dark:text-gray-500 mb-1">File Size</p>
          ...
          <div className="relative group">
            ...
            >
              ...
              {availableSubcategories.map((subcat) => (
                <option key={subcat} value={subcat} className="bg-white dark:bg-gray-900">
                  {subcat}
                </option>
              ))}
            </select>
          ...
          >
            ...
            <div className="relative grid grid-cols-2 gap-2 bg-gray-100 dark:bg-black/40 rounded-xl p-3 mb-5 border border-gray-200 dark:border-white/5">
              <div className="col-span-2 flex items-center space-x-2 text-gray-600 dark:text-gray-400 truncate">
                <File size={14} className="text-emerald-600 dark:text-emerald-500 shrink-0" />
...
{filePreview ? (
                  <div className="relative z-10 text-center">
                    <div className="p-2 bg-white dark:bg-slate-900 rounded-lg inline-block mb-3 shadow-xl">
                      <img
                        src={filePreview}
                        alt="Preview"
                  ...
                  <div className="relative z-10 text-center">
                    <div
                      className={`mb-4 drop-shadow-lg transform group-hover:scale-110 transition-transform duration-300 ${
