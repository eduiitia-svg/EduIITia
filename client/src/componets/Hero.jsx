...
const Hero = () => {
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col pt-12 items-center justify-center overflow-hidden bg-white dark:bg-transparent mb-12 selection:bg-emerald-500/30">
